...
void Game::Run() {
    while (!WindowShouldClose()) {
        ...
        switch (currentScreen) {
            ...
            case PLAYING: UpdateGamePlay(dt); DrawGamePlay(); break;
            case PAUSED: UpdatePause(); DrawPauseMenu(); break;
            case LEVEL_SCORE: UpdateLevelScore(); DrawLevelScoreScreen(); break;
            case GAME_OVER:
                ClearBackground(BLACK);
